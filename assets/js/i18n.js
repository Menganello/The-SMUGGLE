...
(function () {
  ...
  "home.4": { it: "Mappa della rotta Marsala-Tunisi (270 KM)", en: "Map of the Marsala-Tunisia route (270 KM)" },
  "home.5": { it: "Tra Marsala e la Tunisia, sfidando il mare per una missione reale.", en: "Between Marsala and Tunisia, challenging the sea for a real mission." },
...
(function () {
  ...
  "impresa.meta.description": { it: "La traversata di 270km in mare aperto da Marsala alla Tunisia in canoa surfski. Scopri i dettagli operativi e logistici dell'impresa sportiva solidale di The Smuggle.", en: "The 270km open-water crossing from Marsala to Tunisia by surfski canoe. Discover the operational and logistical details of The Smuggle's charity sporting challenge." },
  ...
  "impresa.9": { it: "Da Marsala a Tunisi", en: "From Marsala to Tunis" },
  "impresa.10": { it: "SIMBOLO.", en: "SYMBOL." },
  "impresa.11": { it: "&amp; AZIONE REALE", en: "&amp; REAL ACTION" },
  "impresa.12": { it: "La traversata del Mediterraneo da Marsala a Tunisi non è un gesto provocatorio né un’imitazione del viaggio migratorio.", en: "The Mediterranean crossing from Marsala to Tunis is neither a provocative gesture nor an imitation of the migrant journey." },
...
(function () {
  ...
  "safer.103": { it: "&euro;15.000 <span class=\"text-xs text-white/40 font-normal\">di &euro;9.520</span>", en: "&euro;15.000 <span class=\"text-xs text-white/40 font-normal\">of &euro;9.520</span>" },
  "safer.104": { it: "Progressivo: 158%", en: "Progress: 158%" },
...
(function () {
  ...
  "dona.3": { it: "Ogni miglio percorso in mare e ogni donazione raccolta sono tasselli di un unico grande obiettivo: portare cure neonatali salvavita dove prima era impossibile. Dona in un attimo tramite GoFundMe, oppure con un bonifico diretto alla Fondazione Politecnico di Milano.", en: "Every mile covered at sea and every donation raised are pieces of one great goal: bringing life-saving newborn care where it was once impossible. Donate in a moment via GoFundMe, or with a direct bank transfer to Fondazione Politecnico di Milano." },
  "dona.4": { it: "In alternativa: bonifico diretto alla Fondazione Politecnico di Milano", en: "Alternatively: direct bank transfer to Fondazione Politecnico di Milano" },
...
(function () {
  ...
  "dontraversata.meta.description": { it: "Sostieni Andrea e Giovanni nella traversata di 270km in canoa surfski da Marsala a Tunisi. Il tuo contributo finanzia la logistica e la sicurezza del viaggio.", en: "Support Andrea and Giovanni in their 270km surfski canoe crossing from Marsala to Tunis. Your contribution funds the logistics and safety of the journey." },
